...
public abstract class ActivityAbstractRecog extends ActivityUiRecog {
    ...
    public AlertDialog alertDialogForSet;
public void showDialog(){


//    if (alertDialogForSet == null) {
//        alertDialogForSet = new AlertDialog.Builder(ActivityAbstractRecog.this, R.style.CustomDialogStyle)
//                .create();
//    }

    alertDialogForSet.setCanceledOnTouchOutside(false);
    alertDialogForSet.setOnKeyListener(new DialogInterface.OnKeyListener() {
        @Override
...
//    View v = LayoutInflater.from(ActivityAbstractRecog.this).inflate(R.layout.set_activity_pass_dialog, null, false);
//    TextView sure_to_set = v.findViewById(R.id.sure_to_set);
//    TextView cancle_to_set = v.findViewById(R.id.cancle_to_set);
//    EditText set_pw = v.findViewById(R.id.set_pwd);


    if (ActivityAbstractRecog.this != null && !alertDialogForSet.isShowing()) {
        alertDialogForSet.show();
        alertDialogForSet.getWindow().clearFlags(WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM);
//        alertDialogForSet.setContentView(v);
    }
