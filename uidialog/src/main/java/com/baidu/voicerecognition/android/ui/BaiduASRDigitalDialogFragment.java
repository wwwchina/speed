...
public class BaiduASRDigitalDialogFragment extends BaiduASRDialogFragment {
    ...
    public void onStart() {
        ...
        windowParams.dimAmount = 0f; //将Window周边设置透明为0.7
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       super.onCreateView(inflater,container,savedInstanceState);
        Intent params = getActivity().getIntent();
...
//        mContentRoot.performClick();
    ...
    private void initView() {
        ...
        mContentRoot = View.inflate(getActivity(),
                getResources().getIdentifier("bdspeech_digital_layout", "layout", getActivity().getPackageName()), null);
        if (mContentRoot != null) {
            mContentRoot.findViewWithTag("bg_layout").setBackgroundDrawable(mBg);
//            mContentRoot.setBackgroundColor(Color.rgb(255,255,255));
            ...
            Drawable bgDrawable = getResources().getDrawable(
                    getResources().getIdentifier("bdspeech_close_v2", "drawable", getActivity().getPackageName()));
            ...
            mTipsAdapter = new TipsAdapter(getActivity());
...
//            ((WindowManager.LayoutParams) p).alpha = 1.0f;      //设置本身透明度
//            ((WindowManager.LayoutParams) p).dimAmount = 0.0f;      //设置黑暗度
//
...
//        getWindow().setBackgroundDrawable(new ColorDrawable(0));
    ...
    private void initResources(int theme) {
        ...
        final Integer buttonNormalBgName =
                getResources().getIdentifier("bdspeech_btn_normal", "drawable", getActivity().getPackageName());
        final Integer buttonPressedBgName =
                getResources().getIdentifier("bdspeech_btn_pressed", "drawable", getActivity().getPackageName());
        Integer leftButtonNormalBgName = null;
        Integer leftButtonPressedBgName = null;
        final Integer rightButtonNormalBgName =
                getResources().getIdentifier("bdspeech_right_normal", "drawable", getActivity().getPackageName());
        final Integer rightButtonPressedBgName =
                getResources().getIdentifier("bdspeech_right_pressed", "drawable", getActivity().getPackageName());
        Integer bgName = null;
        ...
        if (BaiduASRDialogTheme.isDeepStyle(theme)) {
            bgName = getResources().getIdentifier("bdspeech_digital_deep_bg", "drawable", getActivity().getPackageName());
            leftButtonNormalBgName =
                    getResources().getIdentifier("bdspeech_left_deep_normal", "drawable", getActivity().getPackageName());
            leftButtonPressedBgName =
                    getResources().getIdentifier("bdspeech_left_deep_pressed", "drawable", getActivity().getPackageName());

            buttonRecognizingBgName =
                    getResources().getIdentifier("bdspeech_btn_recognizing_deep", "drawable", getActivity().getPackageName());
            ...
            mHelpButtonBg.addState(new int[]{android.R.attr.state_pressed}, getResources().getDrawable(
                    getResources().getIdentifier("bdspeech_help_pressed_deep", "drawable", getActivity().getPackageName())));
            mHelpButtonBg.addState(new int[]{}, getResources().getDrawable(
                    getResources().getIdentifier("bdspeech_help_deep", "drawable", getActivity().getPackageName())));
        } else {
            bgName =
                    getResources().getIdentifier("bdspeech_digital_bg", "drawable", getActivity().getPackageName());
            leftButtonNormalBgName =
                    getResources().getIdentifier("bdspeech_left_normal", "drawable", getActivity().getPackageName());
            leftButtonPressedBgName =
                    getResources().getIdentifier("bdspeech_left_pressed", "drawable", getActivity().getPackageName());

            buttonRecognizingBgName =
                    getResources().getIdentifier("bdspeech_btn_recognizing", "drawable", getActivity().getPackageName());
            ...
            mHelpButtonBg.addState(new int[]{android.R.attr.state_pressed}, getResources().getDrawable(
                    getResources().getIdentifier("bdspeech_help_pressed_light", "drawable", getActivity().getPackageName())));
            mHelpButtonBg.addState(new int[]{}, getResources().getDrawable(
                    getResources().getIdentifier("bdspeech_help_light", "drawable", getActivity().getPackageName())));
        }
