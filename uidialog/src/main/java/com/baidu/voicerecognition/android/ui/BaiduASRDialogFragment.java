 ...
 * @author yangliang02
 */
public abstract class BaiduASRDialogFragment extends DialogFragment {
    ...
    public  void setInput(DigitalDialogInput input) {
        this.input = input;
    }
    ...
    private void checkConfig() {
        try {
            ActivityInfo info = getActivity().getPackageManager().getActivityInfo(
                    new ComponentName(getActivity().getPackageName(), getClass().getName()), PackageManager.GET_META_DATA);
...
//        dismiss();
    ...
    protected class DialogListener implements IRecogListener {
        ...
        public void onAsrFinalResult(String[] results, RecogResult recogResult) {
            status = STATUS_None;
            mIsRunning = false;
            BaiduASRDialogFragment.this.onPartialResults(results);
...
//            setResult(RESULT_OK, intentResult);
        ...
        public void onAsrExit() {
            BaiduASRDialogFragment.this.onEndOfSpeech();
