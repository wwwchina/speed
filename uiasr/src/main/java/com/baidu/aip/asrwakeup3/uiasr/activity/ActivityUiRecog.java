...
import com.baidu.aip.asrwakeup3.core.util.ToastUtils;
        ...
        switch (msg.what) { // 处理MessageStatusRecogListener中的状态回调
            case STATUS_FINISHED:
                if (msg.arg2 == 1) {
                    ...
                    ||result.startsWith("0")
                    ||result.length()!=12){
                        Toast.makeText(ActivityUiRecog.this,"号码格式不正确",Toast.LENGTH_LONG).show();
//                        ToastUtils.showMessage(ActivityUiRecog.this,"号码格式不正确");
                      break;
                    }
